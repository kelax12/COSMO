                        ...
                        <div className="relative flex-1">
                          ...
                          <div className="relative w-full sm:w-32">
                            <input
                              ...
                              placeholder="hh:mm"
                              className="w-full px-3 py-2 border border-gray-200 dark:border-white/10 rounded-lg text-sm font-mono font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all dark:bg-slate-900/50 dark:text-white"
                              required />
                          </div>
                      </div>
                    </div>
