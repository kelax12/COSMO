  ...
  return (
    <div className="card p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">OKR en cours</h2>
            <p className="text-gray-600 dark:text-gray-400 text-sm">{activeOKRs.length} objectifs actifs</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {activeOKRs.map(okr => {
            ...
            return (
              <div key={okr.id} className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-gray-900 dark:text-gray-100">{okr.title}</h3>
